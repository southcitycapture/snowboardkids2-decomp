/* Copy of the 10.4u SDK IOKit/usb/USB.h with its three pack(1)/align=reset pairs
 * closed by pack() so GCC 14 accepts it (input_xone.c). */
/*
...
#pragma pack() /* port: GCC 14 rejects "options align=reset" closing a pack(1) */

        ...
        for (i = 0; text[i] != NULL; i++) {
            switch (text[i]) {
                ...
                case 0x47:
                    ...
                    pushViewportCallbackBySlot(priority, layer & 0xFF, renderSpriteFrameWithPalette, elem12);
                    elem12++;
                    break;
                case 0x3A:
        ...
        for (i = 0; text[i] != NULL; i++) {
            switch (text[i]) {
                ...
                case 0x47:
                    ...
                    pushViewportCallbackBySlot(priority, layer & 0xFF, renderTextSpriteWithTransparency, elem16);
                    elem16++;
                    break;
                case 0x3A:
                    elem16->digit = 0xD;

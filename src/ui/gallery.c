...
void setupGalleryMenuState(void) {
    ...
    alloc->lightColors[0].directionX = 0;
    alloc->lightColors[0].directionY = 0x7F;
    alloc->lightColors[0].directionZ = 0x7F;
    ...
    alloc->lightColors[1].directionX = 0x7F;
    alloc->lightColors[1].directionY = 0x7F;
    alloc->lightColors[1].directionZ = 0;
    alloc->lightColors[2].directionX = -0x7F;
    alloc->lightColors[2].directionY = 0x7F;
    alloc->lightColors[2].directionZ = 0;
    alloc->lightColors[2].r = 0x7F;
    alloc->lightColors[2].g = 0x7F;
    alloc->lightColors[2].b = 0x7F;
    alloc->ambientColor.r = 0xD2;
    alloc->ambientColor.g = 0xD2;
    alloc->ambientColor.b = 0xD2;
    setViewportLightColors(alloc->menuViewport.viewportId, 3, alloc->lightColors, &alloc->ambientColor);

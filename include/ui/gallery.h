...
typedef struct {
    ...
    /* 0x628 */ TransformedSpriteArg menuOptionSprites[6];
    /* 0x6B8 */ TransformedSpriteArg menuOptionLabels[6];
    /* 0x748 */ s32 menuOptionAlpha[6];
    /* 0x760 */ u8 menuOptionAnimFrames[6];
    /* 0x766 */ s8 menuOptionAnimTimers[6];
    /* 0x76C */ PaletteSpriteArg itemSprites[27];
    /* 0x91C */ PaletteSpriteArg boardOverlaySprites[27];
    /* 0xACC */ PaletteSpriteArg extraItemSprites[5];
    /* 0xB1C */ PaletteSpriteArg selectionCursor;
    /* 0xB2C */ PaletteSpriteArg pageIndicator;
